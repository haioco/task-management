      ...
      <RightWrapper sx={skin === 'bordered' && !hidden ? { borderLeft: `1px solid ${theme.palette.divider}` } : {}}>
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5'>{` پنل سازمانی هایو ${themeConfig.templateName}! 👋🏻`}</TypographyStyled>
            ...
            <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
              ...
              >
                <FormControlLabel
                  label=' مرا به خاظر بسپار'
                  control={<Checkbox />}
                  sx={{ '& .MuiFormControlLabel-label': { color: 'text.primary' } }}
                />
                <Link passHref href='/forgot-password'>
                  <Typography component={MuiLink} variant='body2' sx={{ color: 'primary.main' }}>
                    رمز عبور خود را قراموش کرده اید ؟
                  </Typography>
                </Link>
              </Box>
              <Button style={{ backgroundColor: '#15133c' }} fullWidth size='large' type='submit' variant='contained' sx={{ mb: 7 }}>
                ورود
              </Button>
