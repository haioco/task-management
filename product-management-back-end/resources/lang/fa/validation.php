...
return [
    ...
    */
    ...
    'project' => [
        ...
        'supervisor' => 'سرپرست پروژه',
        'priority' => 'اولویت پروژه',
        'observer' => 'ناظر پروژه',
        'obsrver report' => 'گذارش ناظر',
        'task' => 'وظیفه پروژه',
        'tasks' => 'وظایف پروژه',
        'message' => [
            'create succeed' => 'پروژه با موفقیت ایجاد شد',
            'update succeed' => 'پروژه با موفقیت بروزرسانی شد',
            'delete succeed' => 'پروژه با موفقیت حذف شد',
            'create failed' => 'ایجاد پروژه با خطا مواجه شد',
            'update failed' => 'بروزرسانی پروژه با خطا مواجه شد',
            'delete failed' => 'حذف پروژه با خطا مواجه شد',
        ]
    ],
];